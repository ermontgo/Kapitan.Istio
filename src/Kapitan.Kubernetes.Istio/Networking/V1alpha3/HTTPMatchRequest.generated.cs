...
namespace Kapitan.Kubernetes.Networking.V1alpha3
{
    public partial class HTTPMatchRequest
    {
        ...
        public Networking.V1alpha3.StringMatch method { get; set; }
        ...
        /** <summary>Describes how to match a given string in HTTP headers. Match is case-sensitive.</summary> */
        public Networking.V1alpha3.StringMatch uri { get; set; }
        /** <summary>Describes how to match a given string in HTTP headers. Match is case-sensitive.</summary> */
        public Networking.V1alpha3.StringMatch scheme { get; set; }
        /** <summary>Describes how to match a given string in HTTP headers. Match is case-sensitive.</summary> */
        public Networking.V1alpha3.StringMatch authority { get; set; }
