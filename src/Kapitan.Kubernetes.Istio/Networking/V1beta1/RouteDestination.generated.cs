...
namespace Kapitan.Kubernetes.Networking.V1beta1
{
    public partial class RouteDestination
    {
        ...
        public Networking.V1beta1.Destination destination { get; set; }
        /** <summary>The proportion of traffic to be forwarded to the service version. If there is only one destination in a rule, all traffic will be routed to it irrespective of the weight.</summary> */
