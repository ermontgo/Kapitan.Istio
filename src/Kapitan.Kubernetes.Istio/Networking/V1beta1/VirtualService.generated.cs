...
namespace Kapitan.Kubernetes.Networking.V1beta1
{
    public partial class VirtualService : IManifestObject
    {
        ...
        public IEnumerable<Networking.V1beta1.TLSRoute> tls { get; set; }
        ...
        public IEnumerable<Networking.V1beta1.TCPRoute> tcp { get; set; }
        ...
        public IEnumerable<Networking.V1beta1.HTTPRoute> http { get; set; }
