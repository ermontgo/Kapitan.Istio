...
namespace Kapitan.Kubernetes.Networking.V1beta1
{
    public partial class HTTPRoute
    {
        ...
        public IEnumerable<Networking.V1beta1.HTTPMatchRequest> match { get; set; }
        ...
        public IEnumerable<Networking.V1beta1.HTTPRouteDestination> route { get; set; }
        ...
        public Networking.V1beta1.HTTPRedirect redirect { get; set; }
        ...
        public Networking.V1beta1.Delegate @delegate { get; set; }
        ...
        public Networking.V1beta1.HTTPRewrite rewrite { get; set; }
        ...
        public Networking.V1beta1.HTTPRetry retries { get; set; }
        ...
        public Networking.V1beta1.HTTPFaultInjection fault { get; set; }
        ...
        public Networking.V1beta1.Destination mirror { get; set; }
        ...
        public Networking.V1beta1.Percent mirrorPercentage { get; set; }
        ...
        public Networking.V1beta1.CorsPolicy corsPolicy { get; set; }
        /** <summary>Message headers can be manipulated when Envoy forwards requests to, or responses from, a destination service. Header manipulation rules can be specified for a specific route destination or for all destinations. The following VirtualService adds a `test` header with the value `true` to requests that are routed to any `reviews` service destination. It also romoves the `foo` response header, but only from responses coming from the `v1` subset (version) of the `reviews` service.</summary> */
        public Networking.V1beta1.Headers headers { get; set; }
    }
}