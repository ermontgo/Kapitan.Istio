...
namespace Kapitan.Kubernetes.Networking.V1beta1
{
    public partial class Sidecar : IManifestObject
    {
        ...
        public IEnumerable<Networking.V1beta1.IstioIngressListener> ingress { get; set; }
        ...
        public IEnumerable<Networking.V1beta1.IstioEgressListener> egress { get; set; }
        ...
        public Networking.V1beta1.OutboundTrafficPolicy outboundTrafficPolicy { get; set; }
    }
}